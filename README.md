...
This library is inspired by and provides equivalent functionality to the original Python [pyOBD](https://github.com/craigastockton/pyOBD) library, with Go-specific improvements:
...
- Original Python [pyOBD](https://github.com/craigastockton/pyOBD) library
